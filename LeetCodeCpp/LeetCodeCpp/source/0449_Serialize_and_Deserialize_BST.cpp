#include "../pch.h"
#include "../header/0449_Serialize_and_Deserialize_BST.hpp"

class SerializeDeserializeBST : public ::testing::Test, public LEETCODE_0449::Codec {
public:
    typedef LEETCODE_0449::TreeNode TreeNode;
};

TEST_F(SerializeDeserializeBST, test1)
{
    Codec ser;
    Codec deser;
